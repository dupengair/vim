...
" >>>>>>>>>>>>>>>>>>> [ YouCompleteMe ]
" 补全菜单配色
highlight Pmenu ctermfg=2 ctermbg=3 guifg=DarkMagenta               " 菜单
highlight PmenuSel ctermfg=2 ctermbg=3 guifg=DarkMagenta            " 选中项
...
:highlight Pmenu ctermfg=3 ctermbg=0 guibg=DarkMagenta              " 补全背景色
:highlight PmenuSel ctermfg=3 ctermbg=0 guibg=DarkMagenta
